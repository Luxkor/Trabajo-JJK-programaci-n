...
function showOfflineTribunal(phase){
  ...
  phase.options.forEach((opt,idx)=>{
    ...
    btn.onclick=()=>{
      ...
      setPhase({type:'tribunal_response',activatorIdx:phase.activatorIdx,accusedIdx:phase.accusedIdx,
...
function showOfflineTribunalAppeal(phase){
  ...
  document.getElementById('btn-apelar').onclick=()=>{
    ...
    setPhase({type:'tribunal_active',activatorIdx:phase.activatorIdx,accusedIdx:phase.accusedIdx,
